-- Function: get_daily_redeem_total
-- Description: Returns the total redeem amount for partially paid and completed requests within a date range (process_status >= 2)
-- Parameters:
...
CREATE OR REPLACE FUNCTION public.get_daily_redeem_total(
...
GRANT EXECUTE ON FUNCTION public.get_daily_redeem_total(timestamptz, timestamptz, uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_daily_redeem_total(timestamptz, timestamptz, uuid) TO anon;
